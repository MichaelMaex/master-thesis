...
\begin{theorem}[Tate's acyclity theorem]\label{thm:tate_acyclity}
...
\begin{proof}
	...
	.\]  
	is exact. 
	\todo{Does it make sense to give a proof of this?}
\end{proof}
...
\begin{proof}
	...
	Taking $M = A_V$ in \cref{thm:tate_acyclity} yields \[
...
It satisfies the properties $(G_0), (G_1)$ and $(G_2)$. 
