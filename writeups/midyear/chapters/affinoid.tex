...
\end{proposition}
\begin{proof}
	That this is well defined is a consequence of Tate's acyclicity theorem (\ref{thm:tate_acyclicity}). 
...
\end{definition}
\begin{proof}
	\todo{find a proof that this still is a sheaf to reference. Too bulky to work out}
\end{proof}
