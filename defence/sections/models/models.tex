	...
	\begin{minipage}[t]{.2\textwidth}
		\begin{example}
			\begin{itemize}
				...
				\item $\mathfrak{m}  = t\cdot \C\llbracket t \rrbracket $ 
				\item $k = \C$
			\end{itemize}
		\end{example}
...
\begin{frame}
	\begin{definition}
		...
		\only<2>{A \emph{model} of a curve $C$  is a normal proper flat $R$-scheme $\sC$ such that $\sC_\eta \simeq C$.}
	\end{definition}
