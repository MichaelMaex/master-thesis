...
{%
    ...
    \vbox to \paperheight{%
        ...
        \vskip-0.57cm\hskip14.61cm\includegraphics[width=0.58cm]{templates/sedes}\hspace*{-1cm}%
        \vfill
    }%
}
...
{%
    ...
    \end{beamercolorbox}%
    \vskip-0.92cm%
    \parbox[t][0.92cm]{\paperwidth}{\hskip13.33cm\includegraphics[width=2.10cm]{templates/kuleuven}}\par%
