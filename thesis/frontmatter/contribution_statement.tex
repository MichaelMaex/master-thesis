...
\Cref{prop:weightfunction_fullback} and its generalization in \cref{rem:weightfunction_fullback_art} about the behavior of weight functions under finite morphisms handed to me by Johannes and Art to whom the first result (\cref{prop:weightfunction_fullback}) was already known before the start of the thesis. 
