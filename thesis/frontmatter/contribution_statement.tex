...
\Cref{prop:weightfunction_fullback} and its generalization in \cref{rem:weightfunction_fullback_art} about the behavior of weight functions under finite morphisms is not cited from any sources because as far as we know it is not published anywhere. 
