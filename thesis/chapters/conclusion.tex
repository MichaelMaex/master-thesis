In \cref{chap:a_berkovich_approach_to_classifying_elliptic_curves} we succesfully solved the main problem (\cref{prob:main_problem}) in the case where $\ch k \ne 2$ using Berkovich geometry. 
