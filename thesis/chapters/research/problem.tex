...
So the question becomes the following. Given an elliptic curve $E$ over $K$, can we get information of $\sk(E)$ like, the topology, lengths, geni,\ldots without computing an snc-model of  $E$?
