...
So the question becomes the following. Given an elliptic curve $E$ over $K$, can we get infomration of $\sk(E)$ like, the topology, lenghts, geni,\ldots without computing an snc model of  $E$?
