...
\begin{exercise}[{\cite[ex.\ 1.3.1]{nicaiseNonarchimedeanGeometry2017}}]\label{exercise:archimedean}
	Let $k$ be a field.
...
\begin{definition}
	...
	.\] 
\end{definition}
\nomenclature[vg]{$\abs{ K^{\times }}$}{Value group of $K$}
\begin{definition}
...
\begin{definition}
	...
	.\end{align*}
\end{definition}
\nomenclature[o]{$K^{\circ}$}{The valuation ring of a non-archimedean field $K$}
\nomenclature[oo]{$K^{\circ \circ}$}{The maximal ideal of the valuation ring of a non-archimedean field $K$}
\nomenclature[tilde]{$\widetilde{K}$}{The residue field of the non-archimedean field $K$}
