...
\begin{definition}\label{def:weight_function_divisorial_point}
	...
	.\] 
\end{definition}
\nomenclature[wt]{$\wt_{\omega}$}{The weight function of the pluricanonical section $\omega$ on $X$}
...
\end{definition}
\nomenclature[skcw]{$\sk(C, \omega)$}{The Kontsevich-Soibelman skeleton on $C$ of $\omega$}
\begin{lemma}
