...
In \cref{sec:}\todo{find the section} we constructed the reduction map $\red_{\mathscr X_s}: X_\text{cl}  \to \mathscr X_s$. 
...
Recall that from \cref{sec:}\todo{where} that we can describe points from the berkovich spectrum as characters, i.e.\ maps from the the spectrum of a complete valued field to $X$.
