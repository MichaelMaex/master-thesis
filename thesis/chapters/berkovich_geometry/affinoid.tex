...
To further develop the theory we need restrict the category of Banach algebras to those that are ``finitely generated'' in some appropriate sense. 
...
\end{definition}
For general $K$-analytic spaces the only requirement that is that a finite union of affinoid domains containing $x$ is a neighborhood of $x$. 
