...
\nomenclature[P]{$\pro^{1}_A$}{The projective line over $A$}
...
\end{definition}
\nomenclature[divisor]{$\divisor_s(\mathscr C)$}{The group of divisors on $\mathscr C$ with support in $\mathscr C_s$}	
...
\end{proof}
\nomenclature[pa]{$p_a(X)$}{The arithmetic genus of $X$}
\nomenclature[chi]{$\chi(\mathcal{L} )$}{The Euler characteristic of the line bundle $\mathcal{L} $}
...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
\nomenclature[fpullback]{$f^*$}{The pullback of a sheaf or divisor}
\nomenclature[fpushforward]{$f_*$}{The pushforward of a sheaf or divisor}
