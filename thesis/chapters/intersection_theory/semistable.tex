...
\end{lemma}
\nomenclature[beta]{$\beta(C)$}{The Betti number of the dual graph of a semistable curve or snc-model}
\begin{proof}
	...
	.\] 
\end{proof}
\nomenclature[genus]{$g(C)$}{The genus of the curve $C$ }
%\nomenclature[g][$g(C)$]{The genus of the curve $C$}
